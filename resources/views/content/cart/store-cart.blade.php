                ...
                <div class="p-5">
                  ...
                  <div class="row mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex number-spinner">
                      <button data-mdb-button-init data-mdb-ripple-init class="btn btn-link px-2" data-dir="down">
                      ...
                      <button data-mdb-button-init data-mdb-ripple-init class="btn btn-link px-2" data-dir="up">
                    ...
                    <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                      <a href="#!" class="text-muted"><i class="bx bx-x"></i></a>
                    </div>
                  </div>
