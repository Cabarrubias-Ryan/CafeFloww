          ...
          <!-- Account Details -->
            <div class="py-3 d-flex justify-content-end">
              <button type="button" class="btn btn-primary" id="employeeButton" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailsModal">
                <span class="tf-icons bx bx-plus me-1"></span>Add Employee
              </button>
            </div>
...
<div class="modal fade" id="detailsModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" id="detailsForm" method="">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input type="text" id="middlename" class="form-control" placeholder="Enter middlename">
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
        ...
        <div class="row pt-3">
          <div class="col mb-3">
            ...
            <input type="text" id="phonenumber" class="form-control" placeholder="Enter phonenumber">
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" value="Save" class="btn btn-primary" id="personSaveBtn">
      </div>
    </form>
  </div>
</div>
